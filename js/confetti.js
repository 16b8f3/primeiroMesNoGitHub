/*
  Esse arquivo não foi criado por mim e sim por
  https://github.com/Agezao
  e o link que eu fiz o donwload desse .js foi
  https://github.com/Agezao/confetti-js/blob/master/dist/index.js
  tinha a versão .min.js mas eu entender o codigo e mudar a cor
  dos confetti
*/
'use strict';
...
function ConfettiGenerator(params) {
  ...
  var appstate = {
    ...
    colors: [[31, 130, 166],[242, 46, 92],[22, 183, 242],[242, 229, 46]], // Colors to render confetti
